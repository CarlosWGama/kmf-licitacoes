            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <!-- LICITAÇÕES -->
                        <li>
                            <a href="{{route('licitacao.listar')}}">
                                <i class="fas fa-balance-scale"></i>Licitações</a>
                                <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="{{route('licitacao.nova')}}">Nova</a>
                                </li>
                                <li>
                                    <a href="{{route('licitacao.listar')}}">Listar</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub @if(isset($menu) && $menu == 'usuarios') active @endif">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="{{route('usuarios.novo')}}">Nova</a>
                                </li>
                                <li>
                                    <a href="{{route('usuarios.listar')}}">Listar</a>
                                </li>
                        ...
                        <!-- LICITAÇÕES -->
                        <li class="has-sub @if(isset($menu) && $menu == 'licitacoes') active @endif">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-balance-scale"></i>Licitações</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>KMF {{date('Y')}}. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
